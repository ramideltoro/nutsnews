<!-- Auto-generated from docs/DEPLOYMENT_CHECKLIST.md. Do not edit this wiki page directly. -->
...
| Document | Purpose |
| --- | --- |
| [Operations](Operations) | Day-to-day operating model |
| [Controller and Shards](Controller-and-Shard-Operations) | Manual controller and shard commands |
| [Performance and Resiliency](Performance-and-Resiliency) | Cache, performance, resiliency, and cost controls |
| [Observability](Observability) | Better Stack, Sentry, structured logs, and dashboards |
| [Troubleshooting Guide](Troubleshooting-Guide) | Diagnose production problems |

<!-- Auto-generated from docs/SUPABASE_RESTORE.md. Do not edit this wiki page directly. -->

> Source: `docs/SUPABASE_RESTORE.md`  
...
Automated production database backup folders are named like `nutsnews-db-2026-06-24_16-32-16` and contain `nutsnews-db-public-tables.sql.gz`, `SHA256SUMS`, and metadata files. See [`NUTSNEWS_DB_BACKUPS.md`](NutsNews-Supabase-Backup-Automation) for the live backup schedule, retention policy, helper commands, and Grafana metrics.

  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Die erlaubte Taxonomie ist absichtlich klein: Standard-Seitenaufrufe, grundlegende Engagement-Signale, grobe Geräte-/Browserklasse, Referrer, ungefährer Standort und Performance-Timing. NutsNews definiert derzeit keine benutzerdefinierten Analyse-Events für Artikelklicks, Likes, gespeicherte Geschichten, Suchanfragen, Kategorien oder persönliche Profile.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "The allowed taxonomy is intentionally small: standard page views, basic engagement signals, coarse device/browser class, referrer, approximate region, and performance timing. NutsNews does not currently define custom analytics events for article clicks, likes, saved stories, searches, categories, or personal profiles.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "許可される分類は意図的に小さくしています。標準のページビュー、基本的なエンゲージメント信号、大まかな端末またはブラウザ種別、参照元、おおよその地域、パフォーマンスタイミングに限ります。NutsNewsは現在、記事クリック、いいね、保存済みストーリー、検索、カテゴリー、個人プロフィールのためのカスタム分析イベントを定義していません。",

...
const germanPrivacyCopy: PrivacyCopy = {
  ...
  highlights: [
    ...
    "Die Website unterstützt keine gespeicherten Geschichten mehr. Frühere Browserdaten werden nicht mehr gelesen und können durch Löschen der Websitedaten entfernt werden.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Die Website speichert Design, Sprache und Analyseauswahl im lokalen Browser-Speicher, wenn Leser diese Steuerelemente verwenden.",
        "Geliktete oder gespeicherte Geschichten bleiben lokal, damit dieselbe Geschichte in der passenden App-Ansicht wieder erscheint. Diese Information wird nicht an ein NutsNews-Konto gesendet, weil NutsNews keine Konten verlangt.",
...
const greekPrivacyCopy: PrivacyCopy = {
  ...
  highlights: [
    ...
    "Ο ιστότοπος δεν υποστηρίζει πλέον αποθήκευση ιστοριών. Τα παλιά δεδομένα δεν διαβάζονται πλέον και μπορούν να αφαιρεθούν με διαγραφή των δεδομένων του ιστότοπου στον browser.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Ο ιστότοπος αποθηκεύει θέμα, γλώσσα και επιλογή analytics στο τοπικό storage του browser όταν οι αναγνώστες χρησιμοποιούν αυτά τα controls.",
        "Οι αγαπημένες ή αποθηκευμένες ιστορίες μένουν τοπικές ώστε η ίδια ιστορία να εμφανίζεται ξανά στην αντίστοιχη προβολή app. Αυτή η πληροφορία δεν αποστέλλεται σε λογαριασμό NutsNews, επειδή το NutsNews δεν απαιτεί λογαριασμούς.",
...
export const privacyCopyByLanguage: Record<LanguageCode, PrivacyCopy> = {
  ...
  en: {
    ...
    highlights: [
      ...
      "The website no longer supports saving stories. Previously saved browser data is no longer read and can be removed by clearing website data in your browser.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "The website stores theme, language, and analytics choice in browser local storage when readers use those controls.",
          "Liked or saved stories stay local so the same story can reappear in the matching app view. This information is not sent to a NutsNews account because NutsNews does not require accounts.",
  ...
  fr: {
    ...
    highlights: [
      ...
      "Le site ne permet plus d’enregistrer des histoires. Les anciennes données ne sont plus lues et peuvent être supprimées en effaçant les données du site dans le navigateur.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Le site stocke le thème, la langue et le choix d’analyse dans le stockage local du navigateur lorsque les lecteurs utilisent ces contrôles.",
          "Les histoires aimées ou enregistrées restent locales afin que la même histoire réapparaisse dans la vue correspondante de l’app. Cette information n’est pas envoyée à un compte NutsNews, car NutsNews ne nécessite pas de compte.",
  ...
  ja: {
    ...
    highlights: [
      ...
      "サイトのストーリー保存機能は終了しました。以前ブラウザに保存したデータは読み込まれず、ブラウザのサイトデータを消去すると削除できます。",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "サイトでは、読者がこれらの操作を使った場合、テーマ、言語、分析の選択をブラウザのローカルストレージに保存します。",
          "いいねまたは保存したストーリーはローカルに残り、同じストーリーが該当するアプリの表示に再び現れます。NutsNewsはアカウントを必要としないため、この情報はNutsNewsアカウントへ送信されません。",

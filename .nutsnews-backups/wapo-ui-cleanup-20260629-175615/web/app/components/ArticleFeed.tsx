...
const copyByLanguage: Record<LanguageCode, FeedCopy> = {
  en: {
    ...
    topStoriesDeck: "A calm front page of positive stories, arranged for quick scanning and deeper reading.",
  ...
  fr: {
    ...
    tryAgain: "Réessayer",
    topStories: "À la une",
    topStoriesDeck: "Une page d’accueil calme avec des histoires positives, faciles à parcourir ou à lire en détail.",
  ...
  ja: {
    ...
    tryAgain: "もう一度試す",
    topStories: "トップストーリー",
    topStoriesDeck: "前向きなニュースを、すばやく読める形で落ち着いた紙面風に並べています。",
    categoryMenu: "セクション",
    leadStory: "リード記事",
    editorsPicks: "注目記事",
    latestBriefs: "最新短報",
  ...
  "de-CH": {
    ...
    topStoriesDeck: "Eine ruhige Startseite mit positiven Geschichten zum schnellen Scannen und Weiterlesen.",
  ...
  el: {
    ...
    topStoriesDeck: "Μια ήρεμη πρώτη σελίδα με θετικές ιστορίες για γρήγορη ανάγνωση και εξερεύνηση.",
